	...
	$.extend({
		...
		confirm: function(msg, title, onOk, onCancle){
			...
			$.modal({
				...
				text: msg,
				buttons: [
					{onClick: onCancle, text: '取消'},
					{onClick: onOk, text: '确定'}
				]
			})
		},
		actions: function(params) {
			...
			var tpl = '<div class="modal-overlay modal-overlay-visible"></div>'+
					'<div class="m-actionsheet">'+title+
						...
						'<div class="actions-cancel actions-cell">取消</div>'
					'</div>'
		...
		template: function(wheelWrapper){
			var tpl = '<div class="picker">'+
					'<div class="picker-panel">'+
						'<div class="picker-title"><span class="cancel"></span><h2 class="title">'+this.opt.title+'</h2><span class="confirm pickerClose">确定</span></div>'+
	...
	CityPicker.prototype = {
		...
		template: function(){
			var tpl = '<div class="picker cityPicker">'+
					'<div class="picker-panel">'+
						'<div class="picker-title"><span class="cancel"></span><h2 class="title">请选择地址</h2><span class="confirm pickerClose">确定</span></div>'+
						'<div class="picker-content">'+
							'<div class="mask-top border-1px"></div>'+
